...
export const VERIFICATION_TOKEN_EMAIL_TEMPLATE =`<html dir="ltr" lang="en">
  <head>
    <link
      rel="preload"
      as="image"
...
export const WELCOME_EMAIL_TEMPLATE = `<html dir="ltr" lang="en">
  <head>
    <link
      rel="preload"
      as="image"
      href="https://react-email-demo-lpdmf0ryo-resend.vercel.app/static/koala-logo.png"
    />
    <meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
    <meta name="x-apple-disable-message-reformatting" />
    <!--$-->
        ...
        <tr style="width:100%">
          <td>
            <img
              alt="Koala"
              height="50"
              src="https://react-email-demo-lpdmf0ryo-resend.vercel.app/static/koala-logo.png"
...
export const RESET_PASSWORD_EMAIL_TEMPLATE = `<html dir="ltr" lang="en">
  <head>
    <link
      rel="preload"
      as="image"
